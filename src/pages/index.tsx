  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover a new way to commute with Car Sharing Application. Explore, book, and share rides seamlessly for a sustainable future."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover a new way to commute with Car Sharing Application. Explore, book, and share rides seamlessly for a sustainable future.`}
            </Text>
            <Box
